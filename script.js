...
const SERVICES = [
  { name: 'Manicure',         icon: 'https://res.cloudinary.com/dbk47jrff/image/upload/v1777664969/manicure_b_hrhetr.jpg',        desc: 'We offer: Classic, Gel & acrylic nail treatments',                        price From: 1500-3000 },
  { name: 'Pedicure',         icon: 'https://res.cloudinary.com/dbk47jrff/image/upload/v1777664969/pedicure_tmimzg.jpg',          desc: 'We offer: Relaxing foot care and nail grooming',                           price From: 1500-3000 },
  { name: 'Wig Installation', icon: 'https://res.cloudinary.com/dbk47jrff/image/upload/v1777664970/wig_installation_gkokcs.jpg',  desc: 'we offer: Professional wig fitting and styling',                           price From: 2500-4500 },
  { name: 'Hair Dressing',    icon: 'https://res.cloudinary.com/dbk47jrff/image/upload/v1777664969/hair_dressing_xb68xg.jpg',     desc: 'We offer: Styling, braiding, and coloring to keep you looking your best',  price From: 3000- },
  { name: 'Barber Shop',      icon: 'https://res.cloudinary.com/dbk47jrff/image/upload/v1777664969/cornrows_hwnvtr.jpg',          desc: 'We offer: Fresh cuts, Cornrows installation, Locs installation and braids',  price From: 400  },
];
